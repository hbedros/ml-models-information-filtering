...
def get_mongo_text(collection, concatenate=False):
    """
    Retrieve the 'text' field from a MongoDB collection.
...
def get_elmr_text(concatenate=False):
    return get_mongo_text(elmr_collection, concatenate)

def get_marr_text(concatenate=False):
    return get_mongo_text(marr_collection, concatenate)
